...
def main(traindataMatrix, testDataMatrix):
    ...
    f = open("result\BPNN_PCA_smote.txt", 'w+', encoding='utf8')
...
if __name__ == "__main__":
    ...
    trainDataMatrix = smote_pca.smote_pca_train('train.data')
    testDataMatrix = smote_pca.smote_pca_test('test.data')
